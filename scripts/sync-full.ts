...
async function main() {
  ...
  // NOTE: After full recovery, manually restore royal_assent_date and act_title
  // on the bills table for all Acts that have received Royal Assent.
  // These fields are not populated by any sync script.
