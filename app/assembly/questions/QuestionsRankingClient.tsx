    ...
    <>
      <div className={styles.filterPanel}>
        ...
        <p className={styles.resultCount} aria-live="polite" aria-atomic="true">
          ...
          <span className={styles.resultCountDesktop}>{partyFilter === 'ALL' ? sittingAdjective(mandate) : partyLabel(partyFilter)} MLA{displayCount !== 1 ? 's' : ''} with questions on record</span>
      ...
      <div className={styles.rankCardHead} aria-hidden="true">
        ...
        <span className={styles.rankCardHeadValue}>Questions</span>
      </div>

      <div className={styles.rankCardList} role="list" aria-label="MLA questions ranked list">
        {visible.map((row, i) => {
          ...
          return (
            ...
            >
              ...
              <span className={styles.rankCardValueCol}>
                ...
                <span className={styles.rankCardValue}>{row.total.toLocaleString()}</span>
              </span>
            </Link>
          )
        })}
