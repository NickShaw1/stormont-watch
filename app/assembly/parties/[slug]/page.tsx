...
const PARTY_DESCRIPTIONS: Record<string, string> = {
  'Sinn Féin': 'Sinn Féin is an Irish republican and democratic socialist political party operating across the island of Ireland. Founded in 1905, the party advocates for Irish unity and has been a central force in Northern Ireland politics since the Good Friday Agreement.',
  'Democratic Unionist Party': 'The Democratic Unionist Party is a unionist and social conservative political party in Northern Ireland. Founded in 1971 by Ian Paisley, the DUP has been one of the dominant forces in Northern Ireland politics for over five decades.',
  ...
  'Ulster Unionist Party': 'The Ulster Unionist Party is a unionist and liberal conservative political party in Northern Ireland. For much of the twentieth century the UUP was the dominant force in Northern Ireland politics, governing the region from partition until the introduction of direct rule.',
