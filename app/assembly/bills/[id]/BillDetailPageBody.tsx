...
/**
 * Shared body for the Bill detail page — rendered by both the live route (current
    ...
    <div className="container" style={{ paddingBottom: 'var(--s-20)' }}>
      ...
      <section aria-labelledby="stages-heading">
        ...
        <p className={styles.guidePrompt}>
          <Link href={`${basePath}/assembly/legislation-guide`}>How does a bill become law? <span aria-hidden="true">↗</span></Link>
        </p>
